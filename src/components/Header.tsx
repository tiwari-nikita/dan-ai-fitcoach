...
const Header = () => {
  return (
    <Card className="bg-gray-800 text-white border-border shadow-lg mb-6 rounded-lg transition-all duration-300 ease-in-out relative mx-auto">
      ...
      <div className="p-4 sm:p-8 flex flex-col items-center justify-center text-center min-h-[180px] sm:min-h-[220px] header-center">
        <div className="flex items-center justify-center mb-5">
          <Dumbbell className="h-14 w-14 mr-4 text-white float-animation" />
